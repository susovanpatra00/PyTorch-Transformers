...
class DecoderBlock(nn.Module):
    ...
    def forward(self, x, encoder_output, src_mask, tgt_msk):
        ...
        x = self.cross_attention_block[1](x, lambda x: self.cross_attention_block(x, encoder_output, encoder_output, src_mask))
...
def BuildTransformer(src_vocab_size: int, tgt_vocab_size: int, src_seq_len: int, tgt_seq_len: int, d_model: int=512, N: int=6, head: int=8, dropout: float=0.1, d_ff: int=2048)-> Transformer:
